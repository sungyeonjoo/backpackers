...
<script>
    function dcheck(){       // 팝업창 열기 함수
       ...
       //window.open('"./attraction_view.jsp?contentid=" + x[i].getElementsByTagName("contentid")[0].childNodes[0].nodeValue +','_blank','width=350,height=200');
       // var place = x[i].getElementsByTagName("contentid")[0].childNodes[0].nodeValue;
       //window.open.location('popup.jsp?contentid=' + place,'_blank','width=350,height=200');
    }    
</script>
...
<body>
    ...
    <!-- 
      <select id="selTest" name="area" onChange="getvalue(this)" style= "width:20%"> 
...
var e = document.getElementById("selTest");
var areacode = e.options[e.selectedIndex].value;
document.write(areacode);

</script>    
 -->
<select id="selarea" onchange="run()">  <!--Call run() function-->
     <option value="">select area</option>
     <option value="./attraction.jsp">Seoul</option>
     <option value="./attraction_busan.jsp">Busan</option>
...
<input type="text" id="srt" placeholder="get value on option select"><br>
 -->
         ...
         // function getvalue(v) {
           //  if (v) {
             //var areacode= document.getElementsByName("area").options[document.getElementsByName("area").options.selectedindex].value;
             
            // }
             //}

//if(document.getElementsByName("area").options[document.getElementsByName("area").options.selectedindex].value == 1){
   //areacode=1;
//}
        ...
        function run() {
           areacode = document.getElementById("selarea").value;
           //if(areacode.value) window.open(areacode.value);
           window.location.href = areacode;
           //document.getElementById("areacode").value = document.getElementById("selarea").value;
        }
           //document.getElementById("areacode").value = document.getElementById("selarea").value;
           //if(areacode == 1){
           //{
      
        xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/areaBasedList?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentTypeId=76&areaCode=1&arrange=B&listYN=Y&pageNo=<%=pageNo%>&numOfRows=12&MobileOS=ETC&MobileApp=Tour",false);
      xmlhttp.send();
...
document.write("</li>");             
      ...
      z = calc(a,b,"/");
       ...
       //document.write("<br>"+f+"<br>");
            ...
            document.write("<li>");
            document.write("<a href='./attraction.jsp?pageNo="+[pageNo] + "'>"+[pageNo]+"</a>"); }
            document.write("</li>");
