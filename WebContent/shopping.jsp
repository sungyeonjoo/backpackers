...
<body>
    ...
    <div id="wrapper">
      ...
      <option value="6">Busan</option>
        ...
        xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/areaBasedList?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentTypeId=79&areaCode=1&arrange=B&listYN=Y&pageNo=<%=pageNo%>&numOfRows=12&MobileOS=ETC&MobileApp=Tour",false);
      ...
      document.write("<a href='./shopping_view.jsp?contentid=" + x[i].getElementsByTagName("contentid")[0].childNodes[0].nodeValue +"'>");
...
document.write("</li>");             
      ...
      z = calc(a,b,"/");
       ...
       //document.write("<br>"+f+"<br>");
            ...
            document.write("<li>");
            document.write("<a href='./shopping.jsp?pageNo="+[pageNo] + "'>"+[pageNo]+"</a>"); }
            document.write("</li>");
