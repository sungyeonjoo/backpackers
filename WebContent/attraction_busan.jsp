...
//}
        ...
        xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/areaBasedList?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentTypeId=76&areaCode=6&arrange=B&listYN=Y&pageNo=<%=pageNo%>&numOfRows=12&MobileOS=ETC&MobileApp=Tour",false);
      xmlhttp.send();
...
document.write("</li>");             
      ...
      z = calc(a,b,"/");
       ...
       //document.write("<br>"+f+"<br>");
            ...
            document.write("<li>");
            document.write("<a href='./attraction_busan.jsp?pageNo="+[pageNo] + "'>"+[pageNo]+"</a>"); }
            document.write("</li>");
