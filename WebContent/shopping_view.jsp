...
<body>
    ...
    <div id="wrapper">
        ...
        xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/detailCommon?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentTypeId=79&contentId=<%=contentid%>&defaultYN=Y&firstImageYN=Y&addrinfoYN=Y&mapinfoYN=Y&overviewYN=Y&transGuideYN=Y&MobileOS=ETC&MobileApp=TourAPI3.0_Guide",false);
       ...
       var detail_length = x[i].getElementsByTagName("title") ;
         ...
         /////////////////////////// detailintro=>restdate/usetime
            ...
            if (detail_length.length==0 ){
               ...
               xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/detailIntro?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentId=<%=contentid%>&contentTypeId=79&introYN=Y&MobileOS=ETC&MobileApp=AppTesting",false);
               xmlhttp.send();
               xmlDoc=xmlhttp.responseXML;
               ...
               var detail2_length = x[i].getElementsByTagName("infocentershopping") ;
               if (detail2_length.length==0 ){
                  document.write("<li> infomation center :  <br>");
               } else {
                  document.write("<li> infomation center : " + x[i].getElementsByTagName("infocentershopping")[0].childNodes[0].nodeValue + "<br>") ;
               }
               
               var detail2_length = x[i].getElementsByTagName("opentime") ;
               if (detail2_length.length==0 ){
                  document.write("<li> open time :  <br>");
               } else {
                  document.write("<li> open time : " + x[i].getElementsByTagName("opentime")[0].childNodes[0].nodeValue + "<br>") ;
               }
               var detail2_length = x[i].getElementsByTagName("restdateshopping") ;
               if (detail2_length.length==0 ){
                  document.write("<li> rest date :  <br>");
               } else {
                  document.write("<li> rest date : " + x[i].getElementsByTagName("restdateshopping")[0].childNodes[0].nodeValue + "<br>") ;
               }
            } 
      ...
      if (window.XMLHttpRequest)
        ...
        xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
            ...
            xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/detailInfo?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentId=<%=contentid%>&contentTypeId=79&MobileOS=ETC&MobileApp=AppTesting",false);
            xmlhttp.send();
            xmlDoc=xmlhttp.responseXML;
            ...
            document.write("<div class='row'>");
             ...
             var detail3_length = x[i].getElementsByTagName("infoname") ;
               if (detail3_length.length==0 ){
                  document.write("<h3>no information name");
               } else {
                  document.write("<h3 class='page-header'>" + x[i].getElementsByTagName("infoname")[0].childNodes[0].nodeValue + "<br>") ;
               }
               document.write("</h3>");

                   var detail_length = x[i].getElementsByTagName("infotext") ;
               if (detail_length.length==0 ){
                  document.write("<div> no information<br>");
               } else {
                  document.write("<div>" + x[i].getElementsByTagName("infotext")[0].childNodes[0].nodeValue + "<br>") ;
               }
               document.write("</div>");
       ...
       <script>
        ...
        xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/detailCommon?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentId=<%=contentid%>&contentTypeId=79&defaultYN=Y&firstImageYN=Y&addrinfoYN=Y&mapinfoYN=Y&overviewYN=Y&transGuideYN=Y&MobileOS=ETC&MobileApp=TourAPI3.0_Guide",false);
