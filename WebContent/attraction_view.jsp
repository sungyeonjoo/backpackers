    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Attraction
        ...
        xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/detailCommon?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentTypeId=76&contentId=<%=contentid%>&defaultYN=Y&firstImageYN=Y&addrinfoYN=Y&mapinfoYN=Y&overviewYN=Y&transGuideYN=Y&MobileOS=ETC&MobileApp=TourAPI3.0_Guide",false);
		 ...
		 var detail_length = x[i].getElementsByTagName("title") ;
			...
			/////////////////////////// detailintro=>restdate/usetime
				...
				if (detail_length.length==0 ){
					...
					xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/detailIntro?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentId=<%=contentid%>&contentTypeId=76&introYN=Y&MobileOS=ETC&MobileApp=AppTesting",false);
					xmlhttp.send();
					xmlDoc=xmlhttp.responseXML;
					...
					var detail2_length = x[i].getElementsByTagName("restdate") ;
					if (detail2_length.length==0 ){
						document.write("<li> restdate :  <br>");
					} else {
						document.write("<li> restdate : " + x[i].getElementsByTagName("restdate")[0].childNodes[0].nodeValue + "<br>") ;
					}
					
					var detail2_length = x[i].getElementsByTagName("usetime") ;
					if (detail2_length.length==0 ){
						document.write("<li> usetime :  <br>");
					} else {
						document.write("<li> usetime : " + x[i].getElementsByTagName("usetime")[0].childNodes[0].nodeValue + "<br>") ;
					}
				} 
		...
		if (window.XMLHttpRequest)
		  ...
		  xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
				...
				xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/detailInfo?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentId=<%=contentid%>&contentTypeId=76&MobileOS=ETC&MobileApp=AppTesting",false);
				xmlhttp.send();
				xmlDoc=xmlhttp.responseXML;
        ...
        xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/detailCommon?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentId=<%=contentid%>&contentTypeId=76&defaultYN=Y&firstImageYN=Y&addrinfoYN=Y&mapinfoYN=Y&overviewYN=Y&transGuideYN=Y&MobileOS=ETC&MobileApp=TourAPI3.0_Guide",false);
