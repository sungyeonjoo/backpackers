...
<body>
    ...
    <div id="wrapper">
       ...
       //for(pageNo=1;pageNo<11;pageNo++){
         
        xmlhttp.open("GET","http://api.visitkorea.or.kr/openapi/service/rest/EngService/areaBasedList?ServiceKey=1EUls2nDhEdmwi9bF8O56vjnt9XW0B%2Fdq3ctZF2KW7oMHnC9UH6qVnWRLPCWddmBRyzFH0kDUsuKqDMqlG%2FsHA%3D%3D&contentTypeId=80&areaCode=1&arrange=B&listYN=Y&pageNo=<%=pageNo%>&numOfRows=12&MobileOS=ETC&MobileApp=Tour",false);
      ...
      var b=xmlDoc.getElementsByTagName("body");
      ...
      document.write("<a href='./accommodation_view.jsp?contentid=" + x[i].getElementsByTagName("contentid")[0].childNodes[0].nodeValue +"'>");
    ...
    // document.write("<a href='/attraction.html?pageNo="+xmlDoc.getElementsByTagName("pageNo")[0].firstChild.nodeValue + "'>");
      // document.write("12345"); 
        ...
        //}
         ...
         //   if (xmlDoc.getElementsByTagName("pageNo")[0].firstChild[0].nodeValue=="<%=pageNo%>") {
      ...
      z = calc(a,b,"/");
       ...
       //document.write("<br>"+f+"<br>");
            // pageNo = request.getParameter("pageNo");       
                  // if (x[i].getElementsByTagName("pageNo")[0].childNodes[0].nodeValue=="<%=pageNo%>"){
                   
            for(pageNo=1;pageNo<=f;pageNo++){
            document.write("<li>");
            document.write("<a href='./accommodation.jsp?pageNo="+[pageNo] + "'>"+[pageNo]+"</a>"); }
            document.write("</li>");
